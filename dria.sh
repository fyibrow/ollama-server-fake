...
for row in $WALLETS; do
  ...
  compute_node_${i}_${n}:
    ...
    environment:
      ...
      DKN_MODELS: llama3.3:70b-instruct-q4_K_M,llama3.1:8b-instruct-q4_K_M,llama3.2:1b-instruct-q4_K_M,qwen3:32b,qwen3:8b,mistral-nemo:12b,gemma3:27b,gemma3:12b,gemma3:4b
